...
class ChromaClient(VectorDBBase):
    ...
    def search(
        ...
        try:
            ...
            log.debug(f"Chroma search() failed for {collection_name}: {e}")
            return None
    ...
    def query(
        ...
        try:
            ...
            log.debug(f"Chroma query() failed for {collection_name}: {e}")
            return None
    ...
    def get(self, collection_name: str) -> Optional[GetResult]:
        ...
        try:
            ...
            log.debug(f"Chroma get() failed for {collection_name}: {e}")
            return None
