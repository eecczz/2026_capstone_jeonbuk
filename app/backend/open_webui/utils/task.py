...
def get_task_model_id(
    ...
    import logging
    _log = logging.getLogger("open_webui.utils.task")

    # Set the task model
    task_model_id = default_model_id
    conn_type = models.get(task_model_id, {}).get("connection_type")
    _log.info(f"TASK_MODEL_RESOLVE: default={default_model_id}, conn_type={conn_type}, task_model={task_model}, task_model_external={task_model_external}, external_in_models={task_model_external in models if task_model_external else False}")
    ...
    _log.info(f"TASK_MODEL_RESOLVE: result={task_model_id}")
