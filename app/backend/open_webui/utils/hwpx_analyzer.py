...
- 같은 의미 후보 줘도 OK (▪과 ㅇ 둘 다 `bullet_item` 후보) — marker_family 분리는 코드가 함
- 차선책은 **의미적으로 구별되는** 후보로 제시 (예: `bullet_item` vs `detail_item`, `note` vs `supplement_note`, `numbered_item` vs `step_item`)
