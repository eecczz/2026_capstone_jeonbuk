...
```json
{
  "paragraphs": [
    ...
    {"idx": 3, "level": 0, "marker": "", "role": "toc", "description": "목차 (텍스트 상자)", "paraPrIDRef": "3", "charPrIDRef": "8"},
    {"idx": 4, "level": 1, "marker": "Ⅰ.", "role": "chapter_title", "description": "대분류 제목 (텍스트 상자)", "paraPrIDRef": "3", "charPrIDRef": "8"},
    {"idx": 5, "level": 2, "marker": "□", "role": "section_header", "description": "중분류 항목 제목", "paraPrIDRef": "0", "charPrIDRef": "0"},
    {"idx": 6, "level": 3, "marker": "ㅇ", "role": "detail_item", "description": "세부 항목의 설명 본문", "paraPrIDRef": "0", "charPrIDRef": "0"},
    {"idx": 7, "level": 4, "marker": "*", "role": "note", "description": "참고/보충 설명", "paraPrIDRef": "0", "charPrIDRef": "0"}
  ],
  "tables": [
...
- ※로 시작하는 보충 설명은 **`note` role로 분리**하세요
...
7. **※ 보충 설명은 `note` role로 분리 (다른 이름 사용 금지)**
