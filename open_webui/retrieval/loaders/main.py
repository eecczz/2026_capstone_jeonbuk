...
from open_webui.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL, REQUESTS_VERIFY, OCR_SERVER_URL
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if file_ext == "pdf":
                ...
                loader = HWPLoader(
                    file_path=file_path,
                    hwp_jar_path=self.kwargs.get("HWP_JAR_PATH", "/app/backend/python-hwplib/hwplib-1.1.8.jar"),
                    hwpx_jar_path=self.kwargs.get("HWPX_JAR_PATH", "/app/backend/python-hwpxlib/hwpxlib-1.0.5.jar")
                )
